...
bool IsBST(Node* currentNode){
	if(currentNode -> _left == NULL && currentNode -> _right == NULL)
		return true;
	
	if(currentNode -> _left == NULL && currentNode -> _right -> value > currentNode -> value)
		return IsBST(currentNode -> _right);
	
	if(currentNode -> _left -> value < currentNode -> value && currentNode -> _right == NULL)
		return IsBST(currentNode -> _left);
		
	if(currentNode -> _left -> value < currentNode -> value && currentNode -> _right -> value > currentNode -> value)
		return IsBST(currentNode -> _right) && IsBST(currentNode -> _left);
